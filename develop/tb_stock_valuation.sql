...
CREATE TABLE IF NOT EXISTS tb_stock_valuation (
    ...
    closing_price DECIMAL(10, 2),  -- 当日收盘价
    daily_change DECIMAL(10, 6),  -- 当日涨跌幅
    market_cap DECIMAL(20, 2),  -- 总市值
    flow_market_cap DECIMAL(20, 2),  -- 流通市值
    total_share BIGINT,  -- 总股本
    float_share BIGINT,  -- 流通股本
    pe_ttm_ratio DECIMAL(10, 8),  -- PE(TTM)
    pe_static_ratio DECIMAL(10, 8),  -- PE(静)
    pb_ratio DECIMAL(10, 8),  -- 市净率
